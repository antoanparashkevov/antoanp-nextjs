        ...
        <section className={ styles['about_section'] }>
            <div className={ styles['about_section_main_content'] }>
                <p className={ styles['about_section_desc'] }>
                    Hi there, my name is Antoan and I’m a web designer and web development specialist (OR more simply said, I create <span>top-tier websites</span> for any type of business).
                    <br/><br/>
