    ...
    return (
        <button
            ...
            className={`
                ...
                ${fill ?
                    "text-amber-50 bg-custom-brown-900 hover:bg-custom-brown-950" :
                    "text-custom-brown-900 bg-white border border-solid border-custom-brown-900 hover:bg-gray-100 hover:border-custom-brown-950"
                }
                ${secondary ? 
                    `${fill ? 
                        "border-0 text-[#ced1d3] bg-[#54595f] hover:bg-[#424548]" :
                        "border-0 text-[#54595f] bg-[#ced1d3] hover:bg-[#abb0b5]"
                    }` :
                    ""
                }
